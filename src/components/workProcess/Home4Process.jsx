                ...
                <div className="content">
                  ...
                  <ul>
                    <li>
                      ...
                      Delivering cutting-edge, custom solutions
                    </li>
                    <li>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <li>
                      ...
                      Tailoring services to meet unique client needs
                    </li>
                  </ul>
                </div>
              </div>
                ...
                <div className="content">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      Adherence to high standards of excellence
                    </li>
                    <li>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="content">
                  ...
                  <ul>
                    ...
                    <li>
                     ...
                     Involving clients in every project step
                    </li>
                    <li>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      Accurately translating client vision into reality
                    </li>
                  </ul>
                </div>
              </div>
                ...
                <div className="content">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      Offering prompt and effective issue resolution
                    </li>
                    <li>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      Delivering peace of mind through reliable service
                    </li>
                  </ul>
                </div>
              </div>
